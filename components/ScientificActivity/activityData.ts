...
const activityData: ActivityListItemData[] = [
  {
    title: "Інновації",
    description:
      "Колектив ДП НДЦПН «Георесурс» НАН України разом зі спеціалістами Національної академії внутрішніх справ, ДСНС, Держспецтрансслужби, Сил підтримки Збройних Сил України проводить тестування новітнього методу дистанційного розмінування територій.",
    image: activity1,
  },
  {
    title: "Методика",
